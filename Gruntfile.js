    ...
    grunt.initConfig({
        ...
        sprite: {
            all: {
                ...
                'cssVarMap': function (sprite) {
                    ...
                    sprite.total_height = Math.ceil(sprite.total_height/2);
                    sprite.total_width = Math.ceil(sprite.total_width/2);
                },
                'cssOpts': {
        ...
        watch: {
            img: {
                ...
                tasks: ['sprite', 'less:development', 'image_resize'] // 'image_resize'
            },
            lesscss: {
                files: 'src/less/**/*.less',
...
//    });
    ...
    grunt.registerTask('default', ['sprite','less:development','image_resize']); // 'image_resize'
